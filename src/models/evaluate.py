...
import dagshub
dagshub.init(repo_owner='Adrshp806', repo_name='uber-demand-prediction', mlflow=True)

# set the mlflow tracking uri
mlflow.set_tracking_uri("https://dagshub.com/Adrshp806/uber-demand-prediction.mlflow")
